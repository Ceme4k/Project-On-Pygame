...
def startScreen():
    ...
    instructionText = ['Переташите звездочки на метки.',
                       'Клавиши со стрелками - для управления',
                       'WASD - для управления камерой',
                       'Пробел - для сброса уровня, Esc - для выхода из игры',
                       'N - для следующего уровня']
